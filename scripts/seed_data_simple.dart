...
// This script will seed your Firestore database with test data
// Run this script with: flutter run -d chrome scripts/seed_data_simple.dart
...
void main() async {
  ...
  // Get the patient users we just created
